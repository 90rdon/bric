...
class OLT_Accordion_Shortcode {
	...
	public static  function accordion_shortcode( $atts, $content ) {
		...
		if("title1"): ?>
			<h3 id="<?php echo ereg_replace("[^A-Za-z0-9]", "", $title)."-".self::$shortcode_count; ?>" ><a href="#<?php echo ereg_replace("[^A-Za-z0-9]", "", $title)."-".self::$shortcode_count; ?>"><img src="http://bricrealty.com/wp-content/uploads/2013/07/tran.png" /></a></h3>
