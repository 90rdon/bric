...
<div class="row-fluid property-listing <?php echo $status_id; ?> clearfix">
	<div class="listing-image span5">
		...
		<?php
			...
			$meta_investment_noi = ($meta_investment_rent * 12) - $meta_investment_hoa - $meta_investment_tax;
			$meta_investment_caprate = $meta_investment_noi / $meta_price;
		?>
	...
	<div class="listing-info span7">
		...
		<div class="listing-content">
			<div class="listing-property-price">
				<?php property_price(true); ?> - Cap Rate: <?php get_custom_percentage($meta_investment_caprate); ?>
			</div>
