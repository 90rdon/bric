<?php
  add_action( 'widgets_init', 'register_community_widget' );
  
  function register_community_widget() {  
    register_widget( 'Community_Information_Widget' );  
  }
  class Community_Information_Widget extends WP_Widget {
    
    function Community_Information_Widget() {
      $widget_ops = array( 'classname' => 'featured-properties', 'description' => __('Community Information - Brochures, Floor plans, etc... ', 'realexpert') );
      $control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'community_information' );
      $this->WP_Widget( 'community_information', __('Real Expert - Community Information', 'realexpert'), $widget_ops, $control_ops );
    }
