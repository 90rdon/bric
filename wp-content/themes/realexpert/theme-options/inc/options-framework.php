...
function optionsframework_menu_settings() {
	...
	$menu = array(
		...
		'icon' => OPTIONS_FRAMEWORK_DIRECTORY.'images/icon-menu.png',
		'position' => 59.5,
...
function optionsframework_add_page() {
	...
	$of_page = add_menu_page( $menu['page_title'], $menu['menu_title'], $menu['capability'], $menu['menu_slug'], $menu['callback'], $menu['icon'], $menu['position'] );
...
function optionsframework_page() { ?>
	...
	<div class="options-tab">
		<div class="span3"><a href="http://demo.puriwp.com/realexpert/documentation/" target="_blank"><?php _e( 'Theme Documentation', 'realexpert' ); ?></a></div>
		<div class="span3"><a href="mailto:support@puriwp.com"><?php _e( 'Theme Support', 'realexpert' ); ?></a></div>
		<div class="span3"><a href="http://themeforest.net/user/minimalthemes/portfolio?WT.ac=item_portfolio&WT.seg_1=item_portfolio&WT.z_author=minimalthemes" target="blank"><?php _e( 'Theme Collection', 'realexpert' ); ?></a></div>
	</div>
