 ...
 <div class="<?php wpp_css('property_overview::row_view', "wpp_row_view wpp_property_view_result"); ?>">
  ...
  <?php foreach ( returned_properties('load_gallery=false') as $property) {  ?>
    ...
    <div class="<?php wpp_css('property_overview::property_div', "property_div {$property['post_type']} clearfix"); ?>">
        ...
        <div class="<?php wpp_css('property_overview::left_column', "wpp_overview_left_column"); ?>" style="width:<?php echo $thumbnail_dimentions['width']+6; /* 12 is boubled image border */?>px; float:left;margin-right:20px; ">
     <?php property_overview_image(); ?>
        ...
        <div class="<?php wpp_css('property_overview::right_column', "wpp_overview_right_column"); ?>" style="margin-left:<?php echo $thumbnail_dimentions['width']+12; /* 12 is boubled image border */?>px; ">
            ...
            <?php if($property['location']): ?>
                <li class="property_address"><a href="<?php echo $property['permalink']; ?>#property_map"><?php echo $property['address']; ?></a></li>
    <li class="other_info"><?php echo "List Price: "; ?><?php echo $property['price']; ?><br><?php echo "Bedrooms: "; ?><?php echo $property['bedrooms']; ?> <br><?php echo "Bathrooms: "; ?><?php echo $property['baths_full']; ?><br><?php echo " Square Feet: "; ?><?php echo $property['sqft']; ?><br><?php echo " Type: "; ?><?php echo $property['random_863']; ?></li>
            <?php endif; ?>
